...
/*
void TAISetArg(uint64_t val, uint32_t idx) {
    tai::Instruction *inst = nullptr;
    switch(idx) {
        case 0:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg0, val);
            break;
        case 1:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg1, val);
            break;
        case 2:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg2, val);
            break;
        case 3:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg3, val);
            break;
        case 4:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg4, val);
            break;
        case 5:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg5, val);
            break;
        case 6:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg6, val);
            break;
        case 7:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg7, val);
            break;
        case 8:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg8, val);
            break;
        case 9:
            inst = tai::CommandQueue::ThreadLocal()->GetProgram()->Movid(tai::Arg9, val);
            break;
        default:
            break;
    }
    if (inst)
        tai::CommandQueue::ThreadLocal()->PushInst(inst);
    tai::CommandQueue::ThreadLocal()->Synchronize();
}
*/